package org.assetloader.example.robotlegs.visualloadertest.utils 
{
	...
	public class StatsMonitor extends Sprite 
	{
		...
		{
			loader.onProgress.add(update);		}

		protected function removeListeners(loader : ILoader) : void 
		{
			loader.onProgress.remove(update);
		}

		protected function update(signal : LoaderSignal = null) : void 
		{
			_field.text = getStatText();
